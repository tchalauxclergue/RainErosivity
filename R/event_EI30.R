...
#'
#' @return A data frame with the calculated EI30 values for each erosive event.
#'
...
#' @references Yin, S., Nearing, M. A., Borrelli, P., Xue, X. (2017). Rainfall Erosivity: An Overview of Methodologies and Applications, Vadose Zone Journal, 16 (12) , 1-16. DOI: https://acsess.onlinelibrary.wiley.com/doi/10.2136/vzj2017.06.0131. doi:10.2136/vzj2017.06.0131
#'
#' @author Thomas Chalaux-Clergue
#'
#' @export
event.EI30 <- function(data, precipitation, temperature, event = "Erosive_event", data.I30, I30.event = "Erosive_event", I30.label = "I30_mm.h.1", record.step = "00:10:00", ceiling = FALSE, precip.units = "mm", min.temperature = 0, digits = 0, ir.factor = 0.08){
  ...
  for(e in resu[[event]]){
    ...
    if(length(p) > 0){
      ...
      for(i in seq_along(p)){
        ...
        er <- 0.29*(1 - 0.72*exp(-ir.factor*ir) ) # Precipitation/rainfall energy per unit depth of precipitation/rainfall (MJ ha^-1 mm^-1)
