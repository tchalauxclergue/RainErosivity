...
#   collapse = TRUE,
#   comment = "#>",
#   fig.path = "man/figures/future_logo.png"
# )
```
...
devtools::build_rmd(files = "D:/Code_R/RainErosivity/RainErosivity/README.Rmd") 
```
...
The `RainErosivity` package is available in this [Github](https://github.com/tchalauxclergue/RainErosivity) repository and archived on [Zenodo](https://doi.org/10.5281/zenodo.14745961).
